...
class TokenizerTFIDF:
    ...
    def __init__(self):
        ...
        self.stopwords = {
            ...
            'this', 'is', 'be', 'are', 'was', 'were', 'been', 'being', 'have', 'has', 'had'
        }
...
class KeywordSearcher:
    ...
    def search(self, query: str, top_k: int = 20) -> List[Tuple[int, float]]:
        ...
        candidate_chunks = self.db_manager.search_chunks_by_tokens(query_tokens, limit=top_k * 2)
        ...
        scored_chunks = []
        for chunk_id, initial_score in candidate_chunks:
