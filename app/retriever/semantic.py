...
class SemanticSearcher:
    ...
    def _load_embeddings_cache(self):
        ...
        try:
            ...
            chunk_ids, embeddings = zip(*embeddings_data)
    ...
    def search(
        ...
        if self._cached_embeddings.size == 0:
    ...
    def get_similarity(self, chunk_id: int, query_embedding: np.ndarray) -> float:
        ...
        try:
            ...
            similarity = float(np.dot(chunk_embedding, normalized_query))
            return similarity
    ...
    def get_cache_info(self) -> Dict[str, Any]:
        ...
        return {
            "cached_chunks": len(self._cached_chunk_ids) if self._cached_chunk_ids else 0,
            "embedding_dimension": self._cached_embeddings.shape[1] if self._cached_embeddings.size > 0 else 0,
