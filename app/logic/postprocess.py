...
class AnswerValidator:
    ...
    def __init__(self):
        ...
        self.warning_phrases = {
            'medical': ['diagnosis', 'prescribe', 'medication', 'treatment', 'medical advice'],
            'legal': ['legal advice', 'lawsuit', 'attorney', 'court case', 'legal counsel'],
            'financial': ['investment advice', 'financial advice', 'buy stocks', 'invest in'],
    ...
    def is_insufficient_evidence_response(self, answer: str) -> bool:
        ...
        return any(phrase in answer_lower for phrase in self.insufficient_evidence_phrases)
...
class AnswerPostProcessor:
    ...
    def process_answer(
        ...
        insufficient_evidence = self.answer_validator.is_insufficient_evidence_response(answer)
        
        if insufficient_evidence:
            return answer, [], True
        
        # Validate citations
        validated_answer, citations_valid = self.citation_processor.validate_citations_in_answer(
            answer, chunks_info
        )
