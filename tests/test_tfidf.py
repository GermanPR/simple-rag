...
from app.retriever.keyword import TokenizerTFIDF
...
class TestTokenizerTFIDF:
    ...
    def test_tfidf_scoring(self):
        ...
        score = tokenizer.calculate_tfidf_scores(
...
class TestKeywordSearcher:
    ...
    def test_index_and_search(self, temp_db):
        ...
        chunk1_id = temp_db.add_chunk(
            doc_id, 1, 0, "machine learning algorithms are powerful"
        )
        chunk2_id = temp_db.add_chunk(
            doc_id, 1, 1, "artificial intelligence and machine learning"
        )
