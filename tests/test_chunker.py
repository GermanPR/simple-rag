...
import pytest
from app.ingest.chunker import HierarchicalChunker, chunk_text
...
class TestHierarchicalChunker:
    ...
    def test_chunk_large_text_with_overlap(self):
        ...
        chunker = HierarchicalChunker(target_size=30, overlap_size=10, min_chunk_size=10)
    ...
    def test_min_chunk_size_respected(self):
        ...
        chunker = HierarchicalChunker(target_size=50, overlap_size=10, min_chunk_size=30)
        
        # Create text with some very short segments
        text = "Short. " + "This is a longer sentence that should be chunked properly. " * 3
        pages_text = [(1, text)]
